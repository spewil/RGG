...
# test_matrix = np.array([[d+n+1 for d in range(5)] for n in range(5)])
# print test_matrix
# plt.clf()
# plt.imshow(test_matrix.T, origin='lower')
# plt.colorbar()
# plt.show()
...
plt.clf()
plt.imshow(gamma_matrix.T, extent=extent, interpolation='nearest', origin='lower')
plt.colorbar()
